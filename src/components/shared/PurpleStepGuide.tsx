      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          >
            ...
            <span className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.3em] text-indigo-200/80">Pro Guide</span>
          </motion.div>

          <h2 className="text-center text-2xl md:text-3xl font-bold text-white sm:text-5xl lg:text-7xl mb-8 sm:mb-16 uppercase tracking-wider leading-[0.95] leading-tight">
            {title}
          </h2>
          ...
          <div className="grid grid-cols-1 gap-8 sm:gap-20 w-full">
            {steps.map((step, idx) => (
              ...
              >
                ...
                <div className="absolute -top-6 sm:-top-10 left-1/2 -translate-x-1/2 text-[6rem] sm:text-[10rem] font-bold text-white/5 select-none pointer-events-none">
                  0{idx + 1}
                </div>
                ...
                <div className="flex flex-col items-center gap-4 sm:gap-6 relative">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <h3 className="text-xl font-bold text-white sm:text-4xl uppercase tracking-wider drop-shadow-md">
                      {step.title}
                    </h3>
