...
export function InstagramPreviewMockup({ type = 'video' }: InstagramPreviewMockupProps) {
  ...
  return (
    <div className="relative w-full aspect-video rounded-3xl overflow-hidden bg-linear-to-tr from-pink-600 via-purple-600 to-orange-500 shadow-2xl group flex items-center justify-center p-4 sm:p-8">
      ...
      <div className="relative z-10 w-full h-full rounded-2xl border border-white/20 bg-white/10 dark:bg-black/30 backdrop-blur-md p-4 sm:p-6 flex flex-col justify-between shadow-2xl">
        ...
        <div className="flex justify-between items-center w-full">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col text-left">
              <span className="text-[11px] font-black text-white leading-none">@savclip_reels</span>
              <span className="text-[9px] font-medium text-white/70">Instagram Saver</span>
            </div>
          </div>
          {/* Pro Pill */}
        ...
        <div className="flex flex-col items-center justify-center my-auto py-1 sm:py-2">
          ...
          {/* Badge */}
          <span className="mt-3 px-4 py-1.5 rounded-full bg-white text-pink-600 font-extrabold uppercase italic tracking-wider text-[10px] sm:text-xs shadow-lg">
            {getLabel()}
          </span>
        </div>
