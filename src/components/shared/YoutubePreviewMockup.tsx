...
export function YoutubePreviewMockup({ type = 'video' }: YoutubePreviewMockupProps) {
  ...
  return (
    <div className="relative w-full aspect-video rounded-3xl overflow-hidden bg-linear-to-tr from-red-700 via-red-600 to-rose-500 shadow-2xl group flex items-center justify-center p-4 sm:p-8">
      {/* Moving Ambient Glows */}
      <div className="absolute inset-0 z-0 opacity-40">
        <div className="absolute -top-10 -left-10 w-72 h-72 rounded-full bg-orange-400/40 blur-3xl animate-pulse" />
        <div className="absolute -bottom-10 -right-10 w-72 h-72 rounded-full bg-red-400/40 blur-3xl animate-pulse" />
      </div>
      ...
      <div className="relative z-10 w-full h-full rounded-2xl border border-white/20 bg-white/10 dark:bg-black/30 backdrop-blur-md p-4 sm:p-6 flex flex-col justify-between shadow-2xl">
        ...
        <div className="flex justify-between items-center w-full">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col text-left">
              <span className="text-[11px] font-black text-white leading-none">@savclip_yt</span>
              <span className="text-[9px] font-medium text-white/70">YouTube Saver</span>
            </div>
          </div>
          {/* Pro Pill */}
          <div className="px-3 py-1 rounded-xl bg-black/20 backdrop-blur-md border border-white/10 text-[9px] font-black text-white uppercase tracking-[0.15em] flex items-center gap-1 shadow-xs">
            ...
            SavClip <span className="text-red-400">Pro</span>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center my-auto py-1 sm:py-2">
          ...
          {/* Badge */}
          <span className="mt-3 px-4 py-1.5 rounded-full bg-white text-red-700 font-extrabold uppercase italic tracking-wider text-[10px] sm:text-xs shadow-lg">
            {getLabel()}
          </span>
        </div>
        ...
        <div className="w-full bg-black/25 dark:bg-black/50 border border-white/10 rounded-xl p-2.5 sm:p-3 flex flex-col sm:flex-row items-center justify-between gap-3 shadow-inner">
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <div className="flex flex-col text-left w-full sm:w-auto">
              <div className="flex items-center gap-2">
                ...
                <span className="px-1.5 py-0.5 rounded-md bg-white/10 text-[9px] font-bold text-white/80">4K MP4</span>
              </div>
              {/* Fake Progress Bar */}
          ...
          <div className="flex items-center gap-4 text-white/80 border-t border-white/5 pt-2 sm:pt-0 sm:border-0 w-full sm:w-auto justify-around sm:justify-end shrink-0">
            ...
            <div className="flex items-center gap-1">
              <MessageCircle className="w-3.5 h-3.5 text-orange-400 fill-orange-400" />
