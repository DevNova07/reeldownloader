...
import { CheckCircle2, Film, HelpCircle, Info, ShieldCheck, StopCircle, Zap, Music, Globe, Layers, Compass, Camera, Monitor, Video, Download } from "lucide-react"
    ...
    <div className="flex flex-col">
      ...
      <StructuredData 
        ...
        data={[
          ...
          { name: "Facebook", item: `https://savclip.com/${locale}/facebook-video-downloader` },
      ...
      <section className={`relative overflow-hidden bg-linear-to-br from-fuchsia-600 via-purple-600 to-sky-500 px-4 pt-10 pb-10 sm:pt-16 sm:pb-24 sm:px-6 lg:px-8 shadow-[inset_0_-20px_60px_rgba(0,0,0,0.1)]`}>
        ...
        <div className="relative z-10 mx-auto max-w-7xl text-center flex flex-col items-center gap-3 sm:gap-6">
          <PlatformTabs   
            ...
            locale={locale}
            items={[
              { id: "video", label: "Video", href: "/facebook-video-downloader", icon: <Globe className="h-4 w-4" /> },
              { id: "reels", label: "Reels", href: "/facebook-reels-downloader", icon: <Layers className="h-4 w-4" /> },
              { id: "story", label: "Story", href: "/facebook-story-saver", icon: <Compass className="h-4 w-4" /> },
              { id: "photo", label: "Photo", href: "/facebook-photo-downloader", icon: <Camera className="h-4 w-4" /> },
            ]} 
          />
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-[clamp(0.85rem,3.5vw,1.1rem)] sm:text-lg font-medium text-white/80 tracking-tight italic drop-shadow-[0_4px_12px_rgba(0,0,0,0.3)] px-4 mt-4 leading-relaxed">
