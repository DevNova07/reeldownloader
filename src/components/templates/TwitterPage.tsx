...
import { Camera, CheckCircle2, Film, Hash, HelpCircle, Info, Music as MusicIcon, ShieldCheck, User, Zap, Monitor, Video, Download } from "lucide-react"
    ...
    <div className="flex flex-col">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-4 pb-2 w-full">
        <Breadcrumbs 
          items={[
            ...
            { name: "Twitter", item: `/${locale}/x-video-downloader` },
      ...
      <section className={`relative overflow-hidden bg-linear-to-br from-fuchsia-600 via-purple-600 to-sky-500 px-4 pt-10 pb-10 sm:pt-16 sm:pb-24 sm:px-6 lg:px-8 shadow-[inset_0_-20px_60px_rgba(0,0,0,0.1)]`}>
          ...
          <PlatformTabs   
            ...
            tabs={dict.tabs}
            items={[
              { id: "video", label: "Video", href: "/x-video-downloader", icon: <Film className="h-4 w-4" /> },
              { id: "gif", label: "GIFs", href: "/x-gif-downloader", icon: <Hash className="h-4 w-4" /> },
              { id: "photo", label: "Photo", href: "/x-profile-picture-downloader", icon: <Camera className="h-4 w-4" /> },
              { id: "media", label: "Media", href: "/x-media-downloader", icon: <Zap className="h-4 w-4" /> },
            ]} 
          />
