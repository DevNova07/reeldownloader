...
import { Camera, CheckCircle2, FileText, HelpCircle, Info, Megaphone, Music as MusicIcon, Send, ShieldCheck, Users, Zap, Monitor, Video, Download } from "lucide-react"
    ...
    <div className="flex flex-col">
      ...
      <section className={`relative overflow-hidden bg-linear-to-br from-fuchsia-600 via-purple-600 to-sky-500 px-4 pt-10 pb-10 sm:pt-16 sm:pb-24 sm:px-6 lg:px-8 shadow-[inset_0_-20px_60px_rgba(0,0,0,0.1)]`}>
          ...
          <PlatformTabs   
            ...
            items={[
              { id: "video", label: "Video", href: "/telegram-video-downloader", icon: <Send className="h-4 w-4" /> },
              { id: "music", label: "MP3", href: "/telegram-audio-downloader", icon: <MusicIcon className="h-4 w-4" /> },
              { id: "photo", label: "Photo", href: "/telegram-photo-downloader", icon: <Camera className="h-4 w-4" /> },
              { id: "files", label: "Files", href: "/telegram-file-downloader", icon: <FileText className="h-4 w-4" /> },
            ]} 
          />
