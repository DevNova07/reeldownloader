...
import { Camera, CheckCircle2, Film, HelpCircle, Info, Music as MusicIcon, ShieldCheck, StopCircle, Zap, Layers, Music, Monitor, Video, Download } from "lucide-react"
      ...
      <section className={`relative overflow-hidden bg-linear-to-br from-fuchsia-600 via-purple-600 to-sky-500 px-4 pt-10 pb-10 sm:pt-16 sm:pb-24 sm:px-6 lg:px-8 shadow-[inset_0_-20px_60px_rgba(0,0,0,0.1)]`}>
        ...
        <div className="relative z-10 mx-auto max-w-7xl text-center flex flex-col items-center gap-3 sm:gap-6">
          <PlatformTabs   
            ...
            locale={locale}
            items={[
              { id: "video", label: "Video", href: "/tiktok-video-downloader", icon: <Music className="h-4 w-4" /> },
              { id: "mp3", label: "MP3", href: "/tiktok-mp3-downloader", icon: <Music className="h-4 w-4" /> },
              { id: "story", label: "Story", href: "/tiktok-story-saver", icon: <Layers className="h-4 w-4" /> },
              { id: "photo", label: "Photo", href: "/tiktok-photo-downloader", icon: <Camera className="h-4 w-4" /> },
            ]} 
          />
