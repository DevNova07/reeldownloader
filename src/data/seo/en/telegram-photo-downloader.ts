export const articleSections = [
    ...
    {
      type: "paragraph",
      content: "Welcome to SavClip, your dedicated utility for archiving stunning visual content from the Telegram ecosystem. Telegram has evolved into much more than a messaging app; it is a global portfolio for photographers, digital artists, and graphic designers who share high-resolution work in dedicated channels. However, the app often compresses images for fast viewing or stores them in deep cache folders that are difficult to access. Our premium Telegram Photo Downloader is specifically engineered to extract the uncompressed, original-quality image file directly from Telegram's cloud servers."
    },
    {
      type: "paragraph",
...
export const header = {
  ...
  title2: "TG Photos",
  title3: "Original HD",
  subtitle: "Effortlessly grab high-quality Telegram photos in seconds."
};
