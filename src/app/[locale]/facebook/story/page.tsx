...
import { StopCircle, Zap, ShieldCheck, CheckCircle2, HelpCircle, Info, Film, PlaySquare, Music as MusicIcon } from "lucide-react"
...
export default function FacebookStoryPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-linear-to-r from-blue-600 to-blue-800 px-4 pt-14 pb-8 sm:pt-20 sm:pb-32 sm:px-6 lg:px-8">
