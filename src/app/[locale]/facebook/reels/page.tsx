...
import { PlaySquare, StopCircle, Zap, ShieldCheck, CheckCircle2, HelpCircle, Info, Film, Music as MusicIcon } from "lucide-react"
  ...
  return (
    <div className="flex flex-col">
      ...
      <StructuredData
        type="HowTo"
        data={{
          name: fbDict.reels.howTo.name,
          description: fbDict.reels.howTo.description,
          steps: fbDict.reels.howTo.steps
        }}
      />
      
      {/* Hero Section */}
      <section className="relative bg-linear-to-r from-blue-600 to-blue-800 px-4 pt-14 pb-8 sm:pt-20 sm:pb-32 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 mx-auto max-w-7xl text-center">
          ...
          <PlatformTabs   
            ...
            items={[
              ...
              { id: "reels", label: dict.tabs.reels, href: "/facebook/reels", icon: <PlaySquare className="h-4 w-4" /> },
      ...
      <VisualGuide 
        platformName={`Facebook ${dict.tabs.reels}`}
        accentColor="text-blue-600"
        bgAccentColor="bg-blue-600"
        Icon={PlaySquare}
        steps={[
          { title: dict.guide.steps[0].title.replace('{platform}', 'Reels'), desc: fbDict.reels.howTo.steps[0], image: "/images/how-to/step1.webp" },
          { title: dict.guide.steps[1].title.replace('{platform}', 'Reels'), desc: fbDict.reels.howTo.steps[1] + " " + fbDict.reels.howTo.steps[2], image: "/images/how-to/step2.webp" },
          { title: dict.guide.steps[2].title.replace('{platform}', 'Reels'), desc: fbDict.reels.howTo.steps[3], image: "/images/how-to/step3.webp" },
        ]}
      />
