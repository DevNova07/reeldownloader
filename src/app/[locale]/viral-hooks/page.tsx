      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="text-center mb-12 sm:mb-20 space-y-6">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 rounded-full bg-yellow-100 px-5 py-2 text-[10px] font-black tracking-[0.2em] text-yellow-700 dark:bg-yellow-900/30"
          >
            <Magnet className="h-4 w-4" />
            Hook Finder
          </motion.div>
          <h1 className="text-5xl md:text-8xl font-black tracking-tight uppercase italicer leading-[0.8]">
            ...
            {step === 1 && (
              ...
              >
                <div className="space-y-6">
                   <h2 className="text-2xl font-black tracking-tight uppercase italicer flex items-center gap-2">
                   ...
                   <input 
                    ...
                    className="h-20 w-full rounded-2xl border-none bg-neutral-100 px-6 text-xl font-bold tracking-tight uppercase italic outline-none ring-2 ring-transparent transition-all focus:bg-white focus:ring-yellow-500/20 dark:bg-neutral-800 dark:focus:bg-neutral-800"
                  />
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Controversial", "Educational", "Curiosity", "FOMO"].map((s) => (
                      <button 
                        key={s}
                        onClick={() => setStyle(s)}
                        className={`rounded-2xl border-2 py-4 text-[10px] font-black tracking-widest uppercase italic transition-all ${style === s ? "border-yellow-500 bg-yellow-500 text-white shadow-lg shadow-yellow-500/20" : "border-neutral-100 bg-neutral-100 text-neutral-500 hover:border-yellow-200 dark:border-neutral-800 dark:bg-neutral-800"}`}
                      >
                        {s}
                      </button>
                    ))}
            ...
            {step === 2 && (
              ...
              >
                <div className="flex items-center justify-between">
                   <h2 className="text-xl font-black tracking-tight uppercase italicer">
                     Results
                   </h2>
                   <button onClick={() => setStep(1)} className="flex items-center gap-2 text-[9px] font-black tracking-widest uppercase italic text-neutral-400 hover:text-yellow-500 transition-colors">
                ...
                <div className="grid gap-3">
                  {result.map((hook, idx) => (
                    ...
                    >
                      <p className="text-base font-bold tracking-tight uppercase italic pr-14 leading-tight">{hook}</p>
                      <button
        ...
        <div className="mt-32 space-y-24">
          <section className="space-y-12">
            <div className="text-center space-y-4">
              ...
              <p className="text-neutral-500 font-bold tracking-widest uppercase italic text-[10px]">Master the First 3 Seconds</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="p-10 rounded-[40px] bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 shadow-xl">
                 <h3 className="text-xl font-black mb-4 dark:text-white underline decoration-yellow-500 decoration-4">The 3-Second Rule</h3>
              ...
              <div className="p-10 rounded-[40px] bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 shadow-xl">
                 <h3 className="text-xl font-black mb-4 dark:text-white underline decoration-yellow-500 decoration-4">Style Matters</h3>
                 <p className="text-sm font-bold text-neutral-500 leading-relaxed">
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              {[
                ...
                <div key={i} className="space-y-2 border-b border-neutral-100 dark:border-neutral-800 pb-6">
                  <h3 className="text-lg font-black tracking-tight uppercase italic dark:text-white">{faq.q}</h3>
