...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return { 
  title: "Telegram Channel Link Generator | SavClip",
  description: "A streamlined, 100% free solution for archiving Telegram media. Experience lightning-fast speeds and pristine clarity.",
