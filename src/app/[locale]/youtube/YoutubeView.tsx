      ...
      <section className="px-4 py-4 sm:py-20 bg-white dark:bg-black sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="mt-10">
            ...
            <p className="mt-4 text-lg text-neutral-500 dark:text-neutral-400 font-medium opacity-80  sm:hidden hidden sm:block">{ytDict.subtitle}</p>
            <p className="mt-4 text-xl text-neutral-600 dark:text-neutral-400 leading-relaxed border-l-4 border-red-500 pl-8 font-medium">
              {ytDict.seo.desc}
            </p>
            ...
            <div className="mt-12 space-y-6">
              ...
              {dict.faq.items.map((faq: any, idx: number) => (
                <div key={idx} className="group rounded-[2rem] border border-neutral-200 p-8 dark:border-neutral-800 hover:border-red-500/50 transition-all bg-white dark:bg-transparent hover:shadow-2xl">
                  <h3 className="font-black text-neutral-900 dark:text-white group-hover:text-red-600 transition-colors tracking-tight uppercase italicer text-lg">{faq.q}</h3>
