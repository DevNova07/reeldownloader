  ...
  return (
    <div className="flex flex-col">
      <StructuredData
        type="HowTo"
        data={{
          name: ytDict.music.howTo.name,
          description: ytDict.music.howTo.description,
          steps: ytDict.music.howTo.steps
        }}
      />
      
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-linear-to-r from-red-600 to-red-800 px-4 pt-10 pb-6 sm:px-6 lg:px-8">
      ...
      <VisualGuide 
        platformName={`YouTube ${dict.tabs.music}`}
        accentColor="text-red-600"
        bgAccentColor="bg-red-600"
        Icon={MusicIcon}
        steps={[
          { title: dict.guide.steps[0].title.replace('{platform}', 'Music'), desc: ytDict.music.howTo.steps[0], image: "/images/how-to/step1.webp" },
          { title: dict.guide.steps[1].title.replace('{platform}', 'Music'), desc: ytDict.music.howTo.steps[1] + " " + ytDict.music.howTo.steps[2], image: "/images/how-to/step2.webp" },
          { title: dict.guide.steps[2].title.replace('{platform}', 'Music'), desc: ytDict.music.howTo.steps[3], image: "/images/how-to/step3.webp" },
        ]}
      />
