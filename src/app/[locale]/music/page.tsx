...
import { Camera, PlaySquare, Music as MusicIcon, StopCircle, Zap, ShieldCheck, CheckCircle2, HelpCircle, Info } from "lucide-react"
...
export default function InstagramMusicPage() {
  ...
  const { addToHistory } = useDownloadHistory("instagram")
  ...
  return (
    <div className="flex flex-col">
      ...
      <StructuredData
        type="HowTo"
        data={{
          name: instaDict.music.howTo.name,
          description: instaDict.music.howTo.description,
          steps: instaDict.music.howTo.steps
        }}
      />
      
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-linear-to-r from-rose-500 to-purple-600 px-4 pt-14 pb-32 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 mx-auto max-w-7xl text-center">
          ...
          <div className="mx-auto max-w-3xl">
            <SearchBar 
              ...
              isLoading={isLoading} 
              dict={dict}
              buttonClass="bg-linear-to-br from-rose-600 via-pink-600 to-purple-600 text-white"
            ...
            <LoadingBar isLoading={isLoading} label={dict.common.analyzing} gradient="from-pink-600 via-purple-600 to-blue-600" />
          </div>
          <DownloadPreview 
            data={downloadData} 
            isLoading={isLoading} 
            buttonStyle="bg-linear-to-br from-rose-600 via-pink-600 to-purple-600 text-white"
      ...
      <VisualGuide 
        platformName={`Instagram ${dict.tabs.music}`}
        accentColor="text-pink-600"
        bgAccentColor="bg-pink-600"
        Icon={MusicIcon}
        steps={[
          { title: dict.guide.steps[0].title.replace('{platform}', 'Music'), desc: instaDict.music.howTo.steps[0], image: "/images/how-to/step1.webp" },
          { title: dict.guide.steps[1].title.replace('{platform}', 'Music'), desc: instaDict.music.howTo.steps[1] + " " + instaDict.music.howTo.steps[2], image: "/images/how-to/step2.webp" },
          { title: dict.guide.steps[2].title.replace('{platform}', 'Music'), desc: instaDict.music.howTo.steps[3], image: "/images/how-to/step3.webp" },
        ]}
      />
