...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service & Conditions of Use – SavClip",
    description: "Read our official Terms of Service. Understand the rules, guidelines, and user agreements governing the use of SavClip utilities.",
    alternates: getSeoAlternates("terms", params.locale),
  }
}
    ...
    <div className="flex flex-col min-h-[60vh] px-4 py-20 sm:px-6 lg:px-8 bg-white dark:bg-black">
      <div className="mx-auto max-w-4xl w-full">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-4xl font-black tracking-tight uppercase italic text-neutral-900 dark:text-white">Terms of Service</h1>
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none text-neutral-600 dark:text-neutral-400 space-y-12">
          <section className="bg-neutral-50 dark:bg-neutral-900/50 p-8 rounded-[2rem] border border-neutral-200 dark:border-neutral-800">
            <div className="flex items-center gap-3 mb-4 text-neutral-900 dark:text-white">
              ...
              <h2 className="text-2xl font-black m-0 leading-tight">1. Acceptance of Terms</h2>
            </div>
            <p className="leading-relaxed font-medium">
              By accessing the website at <a href="https://savclip.com" className="text-blue-600">SavClip</a>, you are agreeing to be bound by these terms of service, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-black text-neutral-900 dark:text-white mb-6 leading-tight">2. Use License & Ethical Usage</h2>
            ...
            <div className="mt-6 p-6 bg-amber-500/5 border-l-4 border-amber-500 rounded-r-2xl">
              ...
              <p className="text-sm font-medium mt-2 m-0">SavClip does not own the media processed through the service. Users are solely responsible for ensuring they have the legal right or explicit permission from the original content creator before downloading any media.</p>
            </div>
          </section>

          <section>
            <h2 className="text-2xl font-black text-neutral-900 dark:text-white mb-6 leading-tight">3. Disclaimer</h2>
          ...
          <section className="bg-neutral-50 dark:bg-neutral-900/50 p-8 rounded-[2rem] border border-neutral-200 dark:border-neutral-800">
            <h2 className="text-2xl font-black text-neutral-900 dark:text-white mb-6 m-0 leading-tight">4. Limitations of Liability</h2>
          ...
          <section>
            <h2 className="text-2xl font-black text-neutral-900 dark:text-white mb-6 leading-tight">5. Accuracy of Materials & External Links</h2>
            <p className="leading-relaxed mb-4">
          ...
          <section className="pt-10 border-t border-neutral-200 dark:border-neutral-800">
            <div className="flex items-center gap-3 mb-4 text-neutral-900 dark:text-white">
              ...
              <h2 className="text-2xl font-black m-0 leading-tight">6. Governing Law</h2>
            </div>
