  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black pt-24 pb-20">
      <article className="max-w-4xl mx-auto px-4">
        <Link href={`/${locale}/blog`} className="inline-flex items-center gap-2 text-neutral-400 font-black uppercase tracking-widest text-[10px] mb-12 hover:text-pink-600 transition-colors">
