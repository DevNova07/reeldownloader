    ...
    <div className="flex flex-col min-h-[60vh] px-4 py-20 sm:px-6 lg:px-8 bg-white dark:bg-black">
      <div className="mx-auto max-w-3xl w-full">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-neutral-200 dark:border-neutral-800 p-6">
            <h4 className="font-bold text-neutral-900 dark:text-white">Do I need to create an account?</h4>
          ...
          <div className="rounded-2xl border border-neutral-200 dark:border-neutral-800 p-6">
            <h4 className="font-bold text-neutral-900 dark:text-white">Are my downloads private?</h4>
