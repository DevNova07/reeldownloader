...
export function TikTokVideoCTA() {
  return (
    <section className="py-24 bg-linear-to-r from-neutral-800 via-neutral-900 to-black text-white text-center px-4">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-2xl sm:text-3xl md:text-4xl md:text-6xl font-black uppercase italic tracking-tighter mb-8 leading-tight">
          Download High-Quality TT Videos
        </h2>
        <p className="text-xl font-bold mb-12 opacity-90">
          Join millions of users and start downloading TikTok videos in HD without watermarks for free.
        </p>
        <button 
