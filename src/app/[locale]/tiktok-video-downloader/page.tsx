...
import { TikTokVideoCTA } from "./TikTokVideoCTA"
import Link from "next/link"
import { Video, Download, Shield, Zap, Music } from "lucide-react"
...
export default async function Page(props: { params: Promise<{ locale: string }> }) {
  const params = await props.params;
  const { locale } = params;
  const seoData = await getToolSeoData("tiktok-video-downloader", locale);
  ...
  return (
    <>
      <StructuredData
        ...
        data={{
          title: "SavClip TikTok Video Downloader",
          description: "Download TikTok videos in HD quality without watermarks for free.",
          ratingValue: "4.9",
          reviewCount: "18400"
        }}
      />
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "Video Downloader", item: `/${locale}/tiktok-video-downloader` }
        ]}
      />
      ...
      <div className="bg-white dark:bg-black pt-8 pb-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-20 rounded-4xl overflow-hidden shadow-2xl border border-neutral-100 dark:border-neutral-800 bg-linear-to-br from-neutral-50 to-white dark:from-neutral-900 dark:to-neutral-950 p-8 md:p-16 flex flex-col items-center text-center">
            <div className="w-24 h-24 bg-black rounded-3xl flex items-center justify-center shadow-2xl mb-8 animate-pulse">
            ...
            <h2 className="text-2xl md:text-3xl md:text-5xl font-black text-neutral-900 dark:text-white uppercase italic tracking-tighter mb-4 leading-tight">
                Fast TT Video Downloader
            </h2>
            <p className="text-lg text-neutral-500 dark:text-neutral-400 font-bold max-w-2xl mb-12">
                Save TikTok videos in MP4 format with original HD quality. No watermark, fast, and 100% secure.
            </p>
