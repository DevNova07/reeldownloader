        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-12 text-neutral-600 dark:text-neutral-400">
          ...
          <section>
             <div className="flex items-center gap-3 text-pink-600 mb-6">
                ...
                <h2 className="text-2xl font-black tracking-widest uppercase italic m-0">1. No Official Affiliation</h2>
             </div>
          ...
          <section>
             <h2 className="text-2xl font-black tracking-widest uppercase italic text-neutral-900 dark:text-white mb-6">2. Fair Use & Legal Compliance</h2>
             <p className="font-medium leading-relaxed">
          ...
          <section className="bg-neutral-50 dark:bg-neutral-900/50 p-8 rounded-[2.5rem] border border-neutral-200 dark:border-neutral-800">
             <h2 className="text-2xl font-black tracking-widest uppercase italic text-neutral-900 dark:text-white mb-6 m-0">3. Technical Operation (No Hosting)</h2>
