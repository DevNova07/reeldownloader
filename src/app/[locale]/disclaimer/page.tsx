      ...
      <div className="mx-auto max-w-4xl w-full">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          <p className="text-lg font-bold text-neutral-600 dark:text-neutral-400 leading-relaxed italic border-l-4 border-neutral-200 dark:border-neutral-800 pl-8">
            Please read this disclaimer carefully before using InstaSnap.
          </p>
          ...
          <section className="space-y-4">
             ...
             <p className="text-neutral-500 dark:text-neutral-400 font-medium">
               This tool is intended to help users download media for their own personal use and fair-use educational purposes. Users are responsible for ensuring that they have the right to download the content they are accessing. InstaSnap does not encourage or condone the unauthorized downloading of copyrighted material.
             </p>
          </section>
          ...
          <section className="space-y-4">
             ...
             <p className="text-neutral-500 dark:text-neutral-400 font-medium">
               InstaSnap is provided "as is" without any warranties of any kind, express or implied. We do not guarantee that the service will be uninterrupted, timely, secure, or error-free.
             </p>
          </section>
        </div>
      </div>
