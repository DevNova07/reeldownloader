...
export function TikTokPhotoCTA() {
  return (
    <section className="py-24 bg-linear-to-r from-sky-500 via-blue-500 to-indigo-600 text-white text-center px-4">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-2xl sm:text-3xl md:text-4xl md:text-6xl font-black uppercase italic tracking-tighter mb-8 leading-tight">
          Save High-Res TT Photos
        </h2>
        <p className="text-xl font-bold mb-12 opacity-90">
          Join millions of users and start downloading high-quality TikTok Photos and Slideshows in HD today.
        </p>
        <button 
