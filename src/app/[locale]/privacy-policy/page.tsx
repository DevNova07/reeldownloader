    ...
    <div className="flex flex-col min-h-[60vh] px-4 py-20 sm:px-6 lg:px-8 bg-white dark:bg-black">
      <div className="mx-auto max-w-4xl w-full">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-4xl font-black tracking-tight text-neutral-900 dark:text-white uppercase italic">Privacy Policy</h1>
            <p className="text-sm font-bold text-neutral-500 uppercase tracking-widest mt-1 hidden sm:block">Last Updated: April 2026</p>
          </div>
        </div>
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none text-neutral-600 dark:text-neutral-400 space-y-12">
          <section className="bg-neutral-50 dark:bg-neutral-900/50 p-8 rounded-[2rem] border border-neutral-200 dark:border-neutral-800">
            <div className="flex items-center gap-3 mb-4 text-neutral-900 dark:text-white">
              ...
              <h2 className="text-2xl font-black uppercase italic m-0">1. Commitment to Privacy</h2>
            </div>
          ...
          <section>
            <h2 className="text-2xl font-black text-neutral-900 dark:text-white uppercase italic mb-6">2. Log Files & Data Processing</h2>
            ...
            <div className="bg-pink-500/5 border-l-4 border-pink-500 p-6 rounded-r-2xl">
               <p className="text-sm font-bold text-pink-600 dark:text-pink-400 uppercase italic m-0">Zero Tracking Policy:</p>
               <p className="text-sm font-medium mt-2 m-0 italic">We do not store or log the URLs you process through our downloader. Your activity remains private and stateless.</p>
            </div>
          </section>

          <section>
            <h2 className="text-2xl font-black text-neutral-900 dark:text-white uppercase italic mb-6">3. Cookies and Web Beacons</h2>
          ...
          <section className="bg-neutral-50 dark:bg-neutral-900/50 p-8 rounded-[2rem] border border-neutral-200 dark:border-neutral-800">
            <h2 className="text-2xl font-black text-neutral-900 dark:text-white uppercase italic mb-6 m-0">4. Google DoubleClick DART Cookie</h2>
          ...
          <section>
            <h2 className="text-2xl font-black text-neutral-900 dark:text-white uppercase italic mb-6">5. CCPA & GDPR Data Protection Rights</h2>
            <p className="leading-relaxed mb-4">
          ...
          <section className="pt-10 border-t border-neutral-200 dark:border-neutral-800">
            <h2 className="text-2xl font-black text-neutral-900 dark:text-white uppercase italic mb-4">6. Consent</h2>
