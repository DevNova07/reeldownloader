  ...
  return (
    <div className="flex flex-col">
      ...
      <StructuredData
        type="HowTo"
        data={{
          name: instaDict.story.howTo.name,
          description: instaDict.story.howTo.description,
          steps: instaDict.story.howTo.steps
        }}
      />
      
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-linear-to-r from-purple-500 via-pink-500 to-rose-500 px-4 pt-14 pb-8 sm:pt-20 sm:pb-32 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 mx-auto max-w-7xl text-center">
          ...
          <PlatformTabs   
            ...
            items={[
              ...
              { id: "story", label: dict.tabs.story, href: "/story", icon: <Story className="h-4 w-4" /> },
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <LoadingBar isLoading={isLoading} label={dict.common.analyzing} gradient="from-purple-500 via-pink-500 to-blue-500" />
          </div>
          <DownloadPreview 
            data={downloadData} 
            isLoading={isLoading} 
      ...
      <VisualGuide 
        platformName={`${dict.categories.insta} ${dict.tabs.story}`}
        accentColor="text-pink-600"
        bgAccentColor="bg-pink-600"
        Icon={Story}
        steps={[
          { title: dict.guide.steps[0].title.replace('{platform}', 'Story'), desc: instaDict.story.howTo.steps[0], image: "/images/how-to/step1.webp" },
          { title: dict.guide.steps[1].title.replace('{platform}', 'Story'), desc: instaDict.story.howTo.steps[1] + " " + instaDict.story.howTo.steps[2], image: "/images/how-to/step2.webp" },
          { title: dict.guide.steps[2].title.replace('{platform}', 'Story'), desc: instaDict.story.howTo.steps[3], image: "/images/how-to/step3.webp" },
        ]}
      />
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-40">
            <h2 className="flex items-center gap-3 text-3xl font-black text-neutral-900 dark:text-white uppercase italic tracking-widest">
              ...
              {dict.platforms.instagram.seo.title}
            </h2>
            <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2">
              {dict.platforms.instagram.seo.features.map((feature: { title: string; desc: string }, idx: number) => (
