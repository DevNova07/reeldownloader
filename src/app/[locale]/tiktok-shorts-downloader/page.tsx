...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  description: "Looking to keep TikTok Shorts permanently? Use our intuitive online utility to get original files in seconds.",
    alternates: getSeoAlternates("tiktok-shorts-downloader", params.locale),
    ...
    <>
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "Shorts Downloader", item: `/${locale}/tiktok-shorts-downloader` }
        ]}
      />
      ...
      <div className="bg-white dark:bg-black pt-8 pb-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-20 rounded-4xl overflow-hidden shadow-2xl border border-neutral-100 dark:border-neutral-800 bg-linear-to-br from-teal-50 to-white dark:from-neutral-900 dark:to-neutral-950 p-8 md:p-16 flex flex-col items-center text-center">
            <div className="w-24 h-24 bg-teal-600 rounded-3xl flex items-center justify-center shadow-2xl mb-8 animate-bounce">
            ...
            <h2 className="text-2xl md:text-3xl md:text-5xl font-black text-neutral-900 dark:text-white uppercase italic tracking-tighter mb-4 leading-tight">
                Viral Shorts Downloader
            </h2>
            <p className="text-lg text-neutral-500 dark:text-neutral-400 font-bold max-w-2xl mb-12">
                Save TikTok shorts and reels in MP4 format with original HD quality. No watermark, fast, and 100% secure.
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full">
                {[
                    { label: "HD Shorts", icon: <Zap className="h-5 w-5" /> },
                    { label: "No Watermark", icon: <Scissors className="h-5 w-5" /> },
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="group p-8 bg-white dark:bg-neutral-900 rounded-3xl shadow-lg border border-neutral-100 dark:border-neutral-800 hover:border-teal-500/30 transition-all">
                ...
                <Link href={`/${locale}`} className="text-xs font-black uppercase tracking-widest text-teal-600 hover:translate-x-1 transition-transform inline-block">Read More →</Link>
              </div>
            ))}
          </div>
        </div>
