          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-neutral-100 bg-neutral-50/50">
                ...
                <th className="px-3 sm:px-8 py-3 text-[10px] sm:text-sm font-black tracking-widest uppercase italic text-neutral-400 text-right">Post Count</th>
              </tr>
            </thead>
            <tbody>
                ...
                >
                  ...
                  <td className="px-3 sm:px-8 py-3">
                    ...
                    >
                        ...
                        <span className="text-lg font-medium text-neutral-900 tracking-tight uppercase italic group-hover/tag:underline decoration-1 underline-offset-4">{item.tag.replace('#', '')}</span>
                    </Link>
                  </td>
