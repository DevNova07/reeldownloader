...
import { Hash, Search, Rocket, X, Copy, Check, Flame, Target, ArrowRight, Settings, Workflow, Heart, Tag, MessageCircle, Send, Bookmark, Star, User } from "lucide-react"
...
// Simple mock logic for hashtag generation
function generateHashtags(keyword: string, platform: string) {
  const base = keyword.split(" ").map(s => s.trim()).filter(s => s.length > 0)
  const variants = ["viral", "trending", "explore", "reels", "foryou", "content", "creator"]
  const results = []
  for (const b of base) {
  ...
  return [...new Set(results)].sort(() => Math.random() - 0.5)
}
...
export default function HashtagPage() {
  ...
  const [platform, setPlatform] = React.useState("general")
  const [results1, setResults1] = React.useState<string[]>([])
  const [results2, setResults2] = React.useState<string[]>([])
  const [results3, setResults3] = React.useState<string[]>([])
  const [isGenerating, setIsGenerating] = React.useState(false)

  const [copyStatus, setCopyStatus] = React.useState<Record<number, boolean>>({ 1: false, 2: false, 3: false })

  const locale = (pathname.split('/')[1] || 'en') as Locale
    const dict = (dictionaries as Record<Locale, any>)[locale] || dictionaries.en

  const hashtagDict = dict.common.hashtag
  ...
  const handleCopy = (tags: string[], id: number) => {
  ...
  return (
    <main className="min-h-screen bg-white pb-12 selection:bg-neutral-100">
      {/* Sub-Navbar */}
      <ToolSubNav />
      ...
      <section className="relative overflow-hidden min-h-[450px] flex items-center justify-center text-center">
        ...
        <div className="relative z-10 mx-auto max-w-4xl space-y-6 px-4 py-20">
          ...
          >
            {hashtagDict.trending_title.split(' ')[0]} <span className="text-[#a4d444] font-normal">{hashtagDict.trending_title.split(' ')[1] || 'NEW'}</span> {hashtagDict.title.split(' ')[1] || 'HASHTAGS'}
          </motion.h1>
      ...
      <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-[1fr_470px] lg:gap-16 lg:items-start lg:px-8">
        ...
        <div className="space-y-24 pt-16">
          ...
          <section className="px-4">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
              ...
              >
                <div className="flex h-24 w-24 items-center justify-center rounded-full bg-neutral-50 shadow-[inset_0_2px_10px_rgba(0,0,0,0.03)] border border-neutral-100">
                  <Settings className="h-10 w-10 text-neutral-400" strokeWidth={1} />
                </div>
                <div className="space-y-3">
                  <h3 className="text-2xl font-bold text-neutral-900 tracking-tight">Best Hashtags for your posts</h3>
                  <p className="text-sm font-normal text-neutral-500 leading-relaxed max-w-[320px] mx-auto">
              ...
              >
                ...
                <div className="space-y-3">
                  <h3 className="text-2xl font-bold text-neutral-900 tracking-tight">Get more Comments</h3>
                  <p className="text-sm font-normal text-neutral-500 leading-relaxed max-w-[320px] mx-auto">
              ...
              >
                ...
                <div className="space-y-3">
                  <h3 className="text-2xl font-bold text-neutral-900 tracking-tight">Get more Likes</h3>
                  <p className="text-sm font-normal text-neutral-500 leading-relaxed max-w-[320px] mx-auto">
          ...
          <section className="relative w-full py-0 bg-neutral-50 border-y border-neutral-100/50 overflow-hidden h-[400px] md:h-[500px]">
            <motion.div
          ...
          <section className="px-4 text-left">
            ...
            >
              <h2 className="text-3xl font-bold text-neutral-900 tracking-tight uppercase underline decoration-[#a4d444] decoration-2 underline-offset-12">Instagram Hashtags</h2>
            ...
            <div className="grid grid-cols-1 gap-16 md:grid-cols-2">
              {[
                ...
                <motion.div
                  ...
                  className="space-y-4"
                >
                  <h3 className="text-xl font-bold text-neutral-900 uppercase">{item.title}</h3>
                  ...
                  <p className="text-[13px] font-medium text-neutral-500 uppercase tracking-tight">{item.desc}</p>
                </motion.div>
              ))}
            </div>
          </section>
          ...
          <section className="px-4 text-left border-t border-neutral-100/50 pt-16">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="mb-16 space-y-4"
            >
              <h2 className="text-3xl font-bold text-neutral-800 tracking-tight uppercase underline decoration-[#a4d444] decoration-2 underline-offset-12">What Our Users Say</h2>
              <p className="max-w-2xl text-[11px] font-bold text-neutral-500 pt-4 uppercase tracking-[0.2em]">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              {[
                ...
                <motion.div
                  ...
                  className="group bg-white p-6 rounded-none border border-neutral-100 shadow-sm hover:shadow-lg transition-all duration-300"
                >
                  ...
                  <p className="text-[14px] text-neutral-600 mb-6 font-medium leading-relaxed">&quot;{review.text}&quot;</p>
                  <div className="flex items-center gap-3 pt-5 border-t border-neutral-50">
                    ...
                    <div className="flex flex-col">
                      <span className="text-[13px] font-bold text-neutral-900 leading-tight">{review.name}</span>
        ...
        <aside className="hidden lg:block sticky top-32 pt-16">
          <motion.div
              ...
              className="w-full max-w-[470px] bg-white border border-neutral-200 rounded-none overflow-hidden shadow-3xl"
          >
              {/* Instagram Header Mockup */}
              <div className="flex items-center justify-between p-4 bg-white">
                  <div className="flex items-center gap-3">
                      <div className="h-10 w-10 rounded-full bg-neutral-50 p-0.5 border border-neutral-100">
                      ...
                      <div className="leading-tight">
                          <p className="text-sm font-bold text-neutral-900 flex items-center gap-1">snaphashtags_official</p>
                          <p className="text-xs font-medium text-neutral-400">1.1M followers</p>
                      </div>
                  </div>
                  <button className="rounded-lg border border-neutral-200 px-4 py-1.5 text-xs font-bold text-neutral-900 transition-colors hover:bg-neutral-50">
                      View profile
                  </button>
              </div>
              ...
              <div className="relative aspect-square w-full overflow-hidden bg-neutral-50">
                  ...
                  <div className="absolute left-6 top-[72%] bg-white/95 px-2 py-0.5 rounded-[2px] shadow-sm border border-neutral-100">
              ...
              <div className="p-4 bg-white">
                  <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-4">
                          <Heart className="h-7 w-7 text-neutral-900" />
                          <MessageCircle className="h-7 w-7 text-neutral-900" />
                          <Send className="h-7 w-7 text-neutral-900" />
                      </div>
                      <Bookmark className="h-7 w-7 text-neutral-900" />
                  </div>

                  {/* Likes & Caption Text */}
                  <div className="space-y-2">
                      <p className="text-sm font-bold text-neutral-900">42,704 likes</p>
                      ...
                      <p className="text-[14px] font-bold text-[#00376b] mt-3 leading-relaxed tracking-tight">
              ...
              <div className="border-t border-neutral-100 p-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                      <div className="h-7 w-7 rounded-full border border-neutral-200 bg-neutral-50" />
                      <span className="text-[14px] text-neutral-300 font-bold">Add a comment...</span>
                  </div>
                  <div className="h-2 w-2 rounded-full bg-neutral-200" />
              </div>
              <div className="p-6 bg-pink-600">
                  <h4 className="text-white font-bold uppercase tracking-tighter text-xl italic">Get Viral Now</h4>
                  <p className="text-pink-100 text-[10px] font-bold uppercase tracking-widest mt-1">Free AI Hashtag Generator</p>
              </div>
          </motion.div>
        </aside>

        {/* Mobile ONLY: Original Mockup Section (Hidden on PC) */}
        <section className="lg:hidden mx-auto max-w-7xl px-4 py-24 flex justify-center border-t border-neutral-100/50 bg-neutral-50/5">
            <motion.div
                initial={{ opacity: 0, y: 40 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                className="w-full max-w-[470px] bg-white border border-neutral-200 rounded-none overflow-hidden shadow-2xl"
            >
                {/* (Duplicate structure for mobile-only feed experience) */}
                <div className="flex items-center justify-between p-4 bg-white">
                    <div className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-full bg-neutral-50 p-0.5 border border-neutral-100">
                            <div className="h-full w-full rounded-full bg-[#f8faf2] flex items-center justify-center">
                ...
                <div className="relative aspect-square w-full overflow-hidden bg-neutral-50">
                    <Image src="/images/instagram-sample.webp" alt="Snap Hashtags" width={500} height={500} className="h-full w-full object-cover" />
                </div>
                <div className="p-4 bg-white">
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-2">
                        <p className="text-sm font-bold text-neutral-900">42,704 likes</p>
                        <p className="text-sm leading-relaxed text-[#00376b] font-bold">#foodie #food #foodporn #viral</p>
                    </div>
                </div>
            </motion.div>
        </section>
