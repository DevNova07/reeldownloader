...
import { ALL_HASHTAGS, NICHE_TAGS, type HashtagNiche } from "@/data/hashtags"

export function HashtagDetailView({ locale, tag }: { locale: string, tag: string }) {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-black">
      ...
      <div className="w-full border-b border-neutral-100 dark:border-neutral-800 bg-neutral-50/30 dark:bg-neutral-900/30">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 md:px-8">
          ...
          <nav className="flex items-center gap-2 text-sm font-medium text-neutral-400">
            <Link href={`/${locale}/hashtags`} className="hover:text-neutral-900 dark:hover:text-white transition-colors">home</Link>
            <ChevronRight className="h-3 w-3" />
            <Link href={`/${locale}/hashtags/best`} className="hover:text-neutral-900 dark:hover:text-white transition-colors">hashtags</Link>
            <ChevronRight className="h-3 w-3" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-32">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="relative group mt-20 md:mt-24">
              ...
              <div className="border border-neutral-100 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900/50 p-4 pt-8 md:p-8 md:pt-10 rounded-none shadow-sm">
                <div className="flex flex-wrap gap-x-3 gap-y-2 md:gap-x-4 md:gap-y-4">
                  {primaryHashtags.map((h, i) => (
                    <span key={i} className="text-[15px] md:text-[17px] font-medium text-neutral-600 dark:text-neutral-400 hover:text-black dark:hover:text-white transition-colors cursor-default">
                      {h}
                    </span>
                  ))}
                </div>
            ...
            <div className="space-y-10">
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div className="flex-1 space-y-3 pt-2">
                  <p className="text-lg font-bold text-neutral-600 dark:text-neutral-400">Post using this hashtag: <span className="text-neutral-900 dark:text-white font-black">2,147,483,647</span></p>
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div className="flex-1 space-y-3 pt-2">
                  <p className="text-lg font-bold text-neutral-600 dark:text-neutral-400">Posts per hour: <span className="text-neutral-900 dark:text-white font-black">24,498</span></p>
                  <div className="h-1.5 w-full bg-neutral-100 dark:bg-neutral-800 rounded-full overflow-hidden">
                    <motion.div 
                        initial={{ width: 0 }}
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div className="flex-1 space-y-3 pt-2">
                  <p className="text-lg font-bold text-neutral-600 dark:text-neutral-400">Average likes per post: <span className="text-neutral-900 dark:text-white font-black">68</span></p>
                  <div className="h-1.5 w-full bg-neutral-100 dark:bg-neutral-800 rounded-full overflow-hidden">
                    <motion.div 
                        initial={{ width: 0 }}
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div className="flex-1 space-y-3 pt-2">
                  <p className="text-lg font-bold text-neutral-600 dark:text-neutral-400">Average comments per post: <span className="text-neutral-900 dark:text-white font-black">2</span></p>
                  <div className="h-1.5 w-full bg-neutral-100 dark:bg-neutral-800 rounded-full overflow-hidden">
                    <motion.div 
                        initial={{ width: 0 }}
      ...
      <section className="bg-[#fcfdfa] dark:bg-neutral-950 pt-32 pb-20 overflow-hidden border-t border-neutral-100/50 dark:border-neutral-900">
        <div className="mx-auto max-w-7xl px-4 md:px-8 text-center pb-12">
            <motion.div
                initial={{ opacity: 0, scale: 0.9 }}
                whileInView={{ opacity: 1, scale: 1 }}
                viewport={{ once: true }}
                className="inline-flex h-20 w-20 items-center justify-center rounded-full bg-neutral-100 dark:bg-neutral-900 text-neutral-300 dark:text-neutral-700 mb-8"
            >
            ...
            <motion.p 
                ...
                className="mx-auto max-w-2xl text-lg font-medium text-neutral-500 dark:text-neutral-400 leading-relaxed mb-6"
            >
        ...
        >
            <div className="absolute inset-0 bg-linear-to-t from-[#fcfdfa] dark:from-neutral-950 via-transparent to-transparent z-10 h-24 bottom-0 top-auto" />
            <Image 
