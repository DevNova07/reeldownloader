...
import { StopCircle, Zap, ShieldCheck, CheckCircle2, HelpCircle, Info, Film, Music as MusicIcon } from "lucide-react"
...
export default function TikTokStoryPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-linear-to-r from-neutral-900 via-neutral-900 to-pink-700 px-4 pt-14 pb-8 sm:pt-20 sm:pb-32 sm:px-6 lg:px-8">
