    ...
    <>
      ...
      <div className="bg-white dark:bg-black pt-8 pb-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-20 rounded-4xl overflow-hidden shadow-2xl border border-neutral-100 dark:border-neutral-800 bg-linear-to-br from-emerald-50 to-white dark:from-neutral-900 dark:to-neutral-950 p-8 md:p-16 flex flex-col items-center text-center">
            <div className="w-24 h-24 bg-emerald-600 rounded-3xl flex items-center justify-center shadow-2xl mb-8 animate-pulse">
            ...
            <h2 className="text-2xl md:text-3xl md:text-5xl font-black text-neutral-900 dark:text-white uppercase italic tracking-tighter mb-4 leading-tight">
                HD TikTok Audio Extractor
            </h2>
            <p className="text-lg text-neutral-500 dark:text-neutral-400 font-bold max-w-2xl mb-12">
                Extract crystal clear audio from TikTok videos and reels. Supports 320kbps high-fidelity MP3 format.
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full">
                {[
                    { label: "320kbps MP3", icon: <Headphones className="h-5 w-5" /> },
                    { label: "Fast Extract", icon: <Zap className="h-5 w-5" /> },
                    { label: "Secure", icon: <Shield className="h-5 w-5" /> },
                    { label: "Unlimited", icon: <Download className="h-5 w-5" /> }
                ].map((item, i) => (
