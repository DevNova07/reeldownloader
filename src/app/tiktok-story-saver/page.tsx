...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("tiktok-story-saver", 'en');
  return { 
    title: seoData.meta?.title || "TikTok Story Downloader – View TT Stories Anonymously HD",
    description: seoData.meta?.description || "Download TikTok stories anonymously in high definition. Save disappearing status videos before the 24-hour limit ends.",
    alternates: getSeoAlternates("tiktok-story-saver", 'en'),
  }
}
    ...
    <>
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "Story Saver", item: `${locale === 'en' ? '' : '/' + locale}/tiktok-story-saver` }
        ]}
      />
