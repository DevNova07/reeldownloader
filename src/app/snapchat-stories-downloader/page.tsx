...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("snapchat-stories-downloader", 'en');
  return { 
    title: seoData.meta?.title || "Snapchat Story Downloader – Download Snap Stories in HD",
    description: seoData.meta?.description || "Download public Snapchat stories before they expire. Save snap status videos in full definition with one click.",
    alternates: getSeoAlternates("snapchat-stories-downloader", 'en'),
  }
}
