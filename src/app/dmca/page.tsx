...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: getSeoAlternates("dmca", 'en'),
  }
}
    ...
    <div className="flex flex-col min-h-screen px-4 py-20 sm:px-6 lg:px-8 bg-white dark:bg-black">
      <div className="mx-auto max-w-4xl w-full">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-12 text-neutral-600 dark:text-neutral-400">
          ...
          <section>
            <h2 className="text-2xl font-black tracking-wider md:tracking-widest uppercase italic text-neutral-900 dark:text-white mb-6 leading-tight">1. Reporting Infringement</h2>
          ...
          <section className="pt-10 border-t border-neutral-200 dark:border-neutral-800">
             <h2 className="text-2xl font-black tracking-wider md:tracking-widest uppercase italic text-neutral-900 dark:text-white mb-4 leading-tight">2. Counter-Notification</h2>
