...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("youtube-description-generator", 'en');
  return { 
    title: seoData.meta?.title || "YouTube Description Generator – AI SEO Video Descriptions",
    description: seoData.meta?.description || "Write search-optimized video text using our AI YouTube Description Generator. Boost your organic SEO rankings instantly.",
    alternates: getSeoAlternates("youtube-description-generator", 'en'),
  }
}
    ...
    <>
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "Description Generator", item: `${locale === 'en' ? '' : '/' + locale}/youtube-description-generator` }
        ]}
      />
      ...
      <section className="py-20 bg-red-600 text-white px-4">
        <div className="max-w-4xl mx-auto text-center">
            ...
            <Link 
                href={`${locale === 'en' ? '' : '/' + locale}/youtube-description-generator`}
