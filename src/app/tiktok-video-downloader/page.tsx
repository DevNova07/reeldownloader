...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("tiktok-video-downloader", 'en');
  return { 
    title: seoData.meta?.title || "TikTok Video Downloader HD – Download TT Videos No Watermark",
    description: seoData.meta?.description || "Download TikTok videos without watermark in HD quality. Free online utility to save public TikTok clips to MP4 format instantly.",
    alternates: getSeoAlternates("tiktok-video-downloader", 'en'),
  }
}
    ...
    <>
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "Video Downloader", item: `${locale === 'en' ? '' : '/' + locale}/tiktok-video-downloader` }
        ]}
      />
