...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("tiktok-mp3-downloader", 'en');
  return { 
    title: seoData.meta?.title || "TikTok MP3 Downloader – Convert TT Video to MP3 HD",
    description: seoData.meta?.description || "Extract audio tracks from TikTok videos. Convert viral TT sounds to high-quality 320kbps MP3 files for free.",
    alternates: getSeoAlternates("tiktok-mp3-downloader", 'en'),
  }
}
    ...
    <>
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "MP3 Downloader", item: `${locale === 'en' ? '' : '/' + locale}/tiktok-mp3-downloader` }
        ]}
      />
