...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: getSeoAlternates("disclaimer", 'en'),
  }
}
    ...
    <div className="flex flex-col min-h-screen px-4 py-20 sm:px-6 lg:px-8 bg-white dark:bg-black">
      <div className="mx-auto max-w-4xl w-full">
        <div className="flex items-center gap-4 mb-8">
           ...
           <div>
             <h1 className="text-4xl font-black tracking-tight uppercase italic text-neutral-900 dark:text-white">Legal Disclaimer</h1>
             <p className="text-sm font-bold text-neutral-500 tracking-widest uppercase italic mt-1 hidden sm:block">Platform Affiliation & Usage Rights</p>
           </div>
        </div>
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-12 text-neutral-600 dark:text-neutral-400">
          <section className="bg-neutral-50 dark:bg-neutral-900/50 p-8 rounded-[2.5rem] border border-neutral-200 dark:border-neutral-800">
            <p className="text-lg font-bold leading-relaxed border-l-4 border-pink-600 pl-8 m-0">
              Please read this legal disclaimer carefully before using the services provided by SavClip.
            </p>
          </section>
          ...
          <section>
             <div className="flex items-center gap-3 text-pink-600 mb-6">
                ...
                <h2 className="text-2xl font-black tracking-wider md:tracking-widest uppercase italic m-0 leading-tight">1. No Official Affiliation</h2>
             </div>
          ...
          <section>
             <h2 className="text-2xl font-black tracking-wider md:tracking-widest uppercase italic text-neutral-900 dark:text-white mb-6 leading-tight">2. Fair Use & Legal Compliance</h2>
             <p className="font-medium leading-relaxed">
          ...
          <section className="bg-neutral-50 dark:bg-neutral-900/50 p-8 rounded-[2.5rem] border border-neutral-200 dark:border-neutral-800">
             <h2 className="text-2xl font-black tracking-wider md:tracking-widest uppercase italic text-neutral-900 dark:text-white mb-6 m-0 leading-tight">3. Technical Operation (No Hosting)</h2>
