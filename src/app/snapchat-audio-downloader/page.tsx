...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("snapchat-audio-downloader", 'en');
  return { 
    title: seoData.meta?.title || "Snapchat MP3 Downloader – Convert Snapchat Video to Audio",
    description: seoData.meta?.description || "Convert Snapchat videos to MP3 audio files. Extract high-quality voice clips and sounds from Snaps effortlessly with SavClip.",
    alternates: getSeoAlternates("snapchat-audio-downloader", 'en'),
  }
}
    ...
    <>
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "MP3 Downloader", item: `${locale === 'en' ? '' : '/' + locale}/snapchat-audio-downloader` }
        ]}
      />
