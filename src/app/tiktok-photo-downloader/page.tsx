...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("tiktok-photo-downloader", 'en');
  return { 
    title: seoData.meta?.title || "TikTok Photo Downloader HD – Save TT Slideshows & Photos",
    description: seoData.meta?.description || "Download TikTok slideshows and photo posts as individual high-resolution images or combined video layouts.",
    alternates: getSeoAlternates("tiktok-photo-downloader", 'en'),
  }
}
    ...
    <>
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "Photo Downloader", item: `${locale === 'en' ? '' : '/' + locale}/tiktok-photo-downloader` }
        ]}
      />
