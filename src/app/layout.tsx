...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    other: {
      ...
      "google-site-verification": process.env.NEXT_PUBLIC_GOOGLE_SITE_VERIFICATION || "google-site-verification-id-here",
    }
  };
}
...
export default async function RootLayout(props: { children: React.ReactNode; }) {
  ...
  return (
    <html lang="en" dir="ltr" suppressHydrationWarning className="scroll-smooth" data-scroll-behavior="smooth">
      <head>
