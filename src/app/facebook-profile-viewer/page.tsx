...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("facebook-profile-viewer", 'en');
  return { 
    title: seoData.meta?.title || "Anonymous Facebook Profile Viewer – View FB Profiles | SavClip",
    description: seoData.meta?.description || "View Facebook profiles securely and anonymously. Explore profile structures and layouts without an active account log in.",
    alternates: getSeoAlternates("facebook-profile-viewer", 'en'),
  }
}
export default async function Page(props: { params: Promise<{ locale: string }> }) {
  const params = await props.params;
  const locale = 'en';
  const seoData = await getToolSeoData("facebook-profile-viewer", locale);
  ...
  return (
    <>
      <StructuredData
        ...
        data={{
          title: "SavClip Facebook Profile Viewer",
          description: "Analyze Facebook profiles anonymously in HD quality for free online.",
          ratingValue: "4.8",
          reviewCount: "2100"
        }}
      />
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "Profile Viewer", item: `${locale === 'en' ? '' : '/' + locale}/facebook-profile-viewer` }
        ]}
      />
      ...
      <Breadcrumb 
        ...
        items={[
          ...
          { label: "Profile Viewer", href: "/facebook-profile-viewer" }
        ]} 
      />
      ...
      <FeaturesSection platform="Facebook Profile" />
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { title: "DP Downloader", href: "/facebook-dp-downloader" }
            ].map((tool, i) => (
              <Link 
                key={i}
      ...
      <FAQSection platform="Facebook Profile" items={faqs} />
      ...
      <div className="bg-white dark:bg-black pb-16 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="rounded-4xl overflow-hidden shadow-2xl border border-neutral-100 dark:border-neutral-800">
                <FacebookPreviewMockup type="profile" />
              </div>
        </div>
      </div>
      ...
      <section className="py-20 bg-blue-600 text-white px-4">
        <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl font-bold mb-12 opacity-90">
                Explore Facebook profiles anonymously with the world's most advanced online viewer.
            </p>
            <Link 
                href={`${locale === 'en' ? '' : '/' + locale}/facebook-profile-viewer`}
