...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("youtube-tag-generator", 'en');
  return { 
    title: seoData.meta?.title || "YouTube Tag Generator – AI SEO Keywords for YT Videos",
    description: seoData.meta?.description || "Find high-volume keywords with our AI YouTube Tag Generator. Improve video indexing and click visibility on search logs.",
    alternates: getSeoAlternates("youtube-tag-generator", 'en'),
  }
}
