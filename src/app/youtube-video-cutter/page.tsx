...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("youtube-video-cutter", 'en');
  return { 
    title: seoData.meta?.title || "YouTube Video Cutter – Trim & Cut YT Videos Online",
    description: seoData.meta?.description || "Trim, split, and crop YouTube videos online. Download specific segments of long files directly without massive bandwidth usage.",
    alternates: getSeoAlternates("youtube-video-cutter", 'en'),
  }
}
    ...
    <>
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "Video Cutter", item: `${locale === 'en' ? '' : '/' + locale}/youtube-video-cutter` }
        ]}
      />
      ...
      <section className="py-20 bg-red-600 text-white px-4">
        <div className="max-w-4xl mx-auto text-center">
            ...
            <Link 
                href={`${locale === 'en' ? '' : '/' + locale}/youtube-video-cutter`}
