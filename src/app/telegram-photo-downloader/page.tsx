...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("telegram-photo-downloader", 'en');
  return { 
    title: seoData.meta?.title || "Telegram Photo Downloader – Save TG Photos in HD",
    description: seoData.meta?.description || "Download images and photos shared on public Telegram channels or groups in full original HD quality.",
    alternates: getSeoAlternates("telegram-photo-downloader", 'en'),
  }
}
    ...
    <>
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "Photo Downloader", item: `${locale === 'en' ? '' : '/' + locale}/telegram-photo-downloader` }
        ]}
      />
      ...
      <section className="py-20 bg-sky-600 text-white px-4 border-t border-sky-500">
        <div className="max-w-4xl mx-auto text-center">
            ...
            <Link 
                href={`${locale === 'en' ? '' : '/' + locale}/telegram-photo-downloader`}
