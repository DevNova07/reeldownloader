...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("telegram-bio-generator", 'en');
  return { 
    title: seoData.meta?.title || "Telegram Bio Generator – AI Powered TG Bio Creator",
    description: seoData.meta?.description || "Create clean, professional, or stylish bios using SavClip",
    alternates: getSeoAlternates("telegram-bio-generator", 'en'),
  }
}
export default async function Page(props: { params: Promise<{ locale: string }> }) {
  const params = await props.params;
  const locale = 'en';
  const seoData = await getToolSeoData("telegram-bio-generator", locale);
  ...
  return (
    <>
      <StructuredData
        ...
        data={{
          title: "SavClip Telegram Bio Generator",
          description: "Generate professional and creative Telegram bios using AI for free.",
          ratingValue: "4.8",
          reviewCount: "2900"
        }}
      />
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "Bio Generator", item: `${locale === 'en' ? '' : '/' + locale}/telegram-bio-generator` }
        ]}
      />
      ...
      <Breadcrumb 
        ...
        items={[
          ...
          { label: "Bio Generator", href: "/telegram-bio-generator" }
        ]} 
      />
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { title: "Channel Finder", href: "/telegram-trending-channel-finder" },
      ...
      <div className="bg-white dark:bg-black pb-16 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="rounded-4xl overflow-hidden shadow-2xl border border-neutral-100 dark:border-neutral-800">
                <TelegramPreviewMockup type="bio" />
              </div>
        </div>
      </div>
      ...
      <section className="py-20 bg-sky-600 text-white px-4 border-t border-sky-500">
        <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl font-bold mb-12 opacity-90 text-sky-100">
                Generate high-converting Telegram bios instantly with our professional AI copywriting tool.
            </p>
            <Link 
                href={`${locale === 'en' ? '' : '/' + locale}/telegram-bio-generator`}
