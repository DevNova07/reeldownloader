...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("facebook-reels-downloader", 'en');
  return { 
    title: seoData.meta?.title || "Facebook Reels Downloader: Save Reels in HD | SavClip",
    description: seoData.meta?.description || "Download Facebook Reels in HD quality without watermark. Save viral FB short videos directly to your device gallery for free.",
    alternates: getSeoAlternates("facebook-reels-downloader", 'en'),
  }
}
    ...
    <>
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "Reels Downloader", item: `${locale === 'en' ? '' : '/' + locale}/facebook-reels-downloader` }
        ]}
      />
