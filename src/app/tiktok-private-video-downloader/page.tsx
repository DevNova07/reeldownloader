...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("tiktok-private-video-downloader", 'en');
  return { 
    title: seoData.meta?.title || "TikTok Private Video Downloader – Save Private TT Videos",
    description: seoData.meta?.description || "Save private TikTok videos securely from accounts you follow. Extract your favorite protected content hassle-free.",
    alternates: getSeoAlternates("tiktok-private-video-downloader", 'en'),
  }
}
    ...
    <>
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "Private Downloader", item: `${locale === 'en' ? '' : '/' + locale}/tiktok-private-video-downloader` }
        ]}
      />
      ...
      <section className="py-20 bg-pink-600 text-white px-4">
        <div className="max-w-4xl mx-auto text-center">
            ...
            <Link 
                href={`${locale === 'en' ? '' : '/' + locale}/tiktok-private-video-downloader`}
