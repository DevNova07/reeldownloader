...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("facebook-page-audit-tool", 'en');
  return { 
    title: seoData.meta?.title || "Facebook Page Audit: Analyze FB Pages Online",
    description: seoData.meta?.description || "Analyze any Facebook Page instantly. Check performance metrics, engagement rates, and optimize your FB strategy using our audit tool.",
    alternates: getSeoAlternates("facebook-page-audit-tool", 'en'),
  }
}
export default async function Page(props: { params: Promise<{ locale: string }> }) {
  const params = await props.params;
  const locale = 'en';
  const seoData = await getToolSeoData("facebook-page-audit-tool", locale);
  ...
  return (
    <>
      <StructuredData
        ...
        data={{
          title: "SavClip Facebook Page Audit Tool",
          description: "Audit Facebook pages anonymously in HD quality for free online.",
          ratingValue: "4.8",
          reviewCount: "1100"
        }}
      />
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "Page Audit", item: `${locale === 'en' ? '' : '/' + locale}/facebook-page-audit-tool` }
        ]}
      />
      ...
      <Breadcrumb 
        ...
        items={[
          ...
          { label: "Page Audit", href: "/facebook-page-audit-tool" }
        ]} 
      />
      ...
      <FeaturesSection platform="Facebook Page" />
      ...
      <FAQSection platform="Facebook Page" items={faqs} />
      ...
      <section className="py-20 bg-blue-600 text-white px-4">
        <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl font-bold mb-12 opacity-90">
                Audit any public Facebook page anonymously with the world's most sophisticated online tool.
            </p>
            <Link 
                href={`${locale === 'en' ? '' : '/' + locale}/facebook-page-audit-tool`}
