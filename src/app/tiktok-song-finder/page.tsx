...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("tiktok-song-finder", 'en');
  return { 
    title: seoData.meta?.title || "TikTok Song Finder – Identify Trending Audio",
    description: seoData.meta?.description || "Identify trending music tracks and sounds on TikTok. Find viral audio details to use in your next short video project.",
    alternates: getSeoAlternates("tiktok-song-finder", 'en'),
  }
}
    ...
    <>
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "Song Finder", item: `${locale === 'en' ? '' : '/' + locale}/tiktok-song-finder` }
        ]}
      />
      ...
      <section className="py-20 bg-pink-600 text-white px-4">
        <div className="max-w-4xl mx-auto text-center">
            ...
            <Link 
                href={`${locale === 'en' ? '' : '/' + locale}/tiktok-song-finder`}
