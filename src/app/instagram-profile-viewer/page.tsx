...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("instagram-profile-viewer", 'en');
  return { 
    title: seoData.meta?.title || "Instagram Profile Viewer – View IG Profiles Anonymously | SavClip",
    description: seoData.meta?.description || "View Instagram profiles anonymously without logging in. Explore bios, public posts, and grid layouts privately with SavClip.",
    alternates: getSeoAlternates("instagram-profile-viewer", 'en'),
  }
}
