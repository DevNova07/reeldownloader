...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("instagram-video-downloader", 'en');
  return { 
    title: seoData.meta?.title || "Download Instagram Videos Without Watermark in HD – SavClip",
    description: seoData.meta?.description || "Download Instagram videos to MP4 format in full resolution. Free online utility to save public IG videos instantly with no watermark.",
    alternates: getSeoAlternates("instagram-video-downloader", 'en'),
  }
}
    ...
    <>
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "Video Downloader", item: `${locale === 'en' ? '' : '/' + locale}/instagram-video-downloader` }
        ]}
      />
