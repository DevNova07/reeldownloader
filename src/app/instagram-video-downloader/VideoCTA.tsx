...
export function VideoCTA() {
  return (
    <section className="py-24 bg-linear-to-r from-blue-600 via-indigo-600 to-violet-600 text-white text-center px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-xl font-bold mb-12 opacity-90">
          Join millions of users and start downloading high-quality Instagram Videos without watermarks today.
        </p>
        <button 
