...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("youtube-subtitle-downloader", 'en');
  return { 
    title: seoData.meta?.title || "YouTube Subtitle Downloader – Download CC/Subtitles SRT, TXT",
    description: seoData.meta?.description || "Extract closed captions effortlessly. Download YouTube subtitles in clean SRT or TXT formats across multiple languages.",
    alternates: getSeoAlternates("youtube-subtitle-downloader", 'en'),
  }
}
