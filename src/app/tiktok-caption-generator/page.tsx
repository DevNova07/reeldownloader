...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const seoData = await getToolSeoData("tiktok-caption-generator", 'en');
  return { 
    title: seoData.meta?.title || "TikTok Caption Generator – AI Video Captions",
    description: seoData.meta?.description || "Craft high-engagement text scripts using SavClip",
    alternates: getSeoAlternates("tiktok-caption-generator", 'en'),
  }
}
    ...
    <>
      ...
      <StructuredData
        ...
        data={[
          ...
          { name: "Caption Generator", item: `${locale === 'en' ? '' : '/' + locale}/tiktok-caption-generator` }
        ]}
      />
      ...
      <section className="py-20 bg-pink-600 text-white px-4">
        <div className="max-w-4xl mx-auto text-center">
            ...
            <Link 
                href={`${locale === 'en' ? '' : '/' + locale}/tiktok-caption-generator`}
