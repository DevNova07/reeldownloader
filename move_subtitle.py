...
for filepath in tsx_files:
    ...
    # We look for the <p> tag inside the motion.div after the <h1>
    ...
    if match:
        ...
        # 3. Insert into SEO Section
        # Look for the SEO header
        ...
        if re.search(seo_pattern, content, re.DOTALL):
            ...
            content = re.sub(seo_pattern, replacement, content, flags=re.DOTALL)
            modified = True
